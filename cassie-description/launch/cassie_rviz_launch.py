...
def generate_launch_description():
    ...
    model_file_dir = os.path.join(pkg_share_pth, 'urdf/cassie_rigid.urdf')
    ...
    return LaunchDescription([
        ...
        DeclareLaunchArgument(name='namespace',default_value='/cassie',
                            description='Provide namespace for nodes and topics'),
