...
## About The Project
<p align="left">
This project is a C++ adaptation of Stephane Caron's [pink](https://github.com/stephane-caron/pink) python package, utilising the Pinocchio library in its native C++ for efficient derivation and computation of inverse kinematics. 
...
* [casadi](https://github.com/casadi/casadi) (Installed with any desired QP solvers for `conic()` - see [here](https://github.com/casadi/casadi/wiki/InstallationLinux))
